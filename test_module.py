...
class DemographicAnalyzerTestCase(unittest.TestCase):
    ...
    def test_race_count(self):
        ...
        self.assertCountEqual(actual, expected, "Expected race count to be [27816, 3124, 1039, 311, 271]")
    ...
    def test_rich_percentage(self):
        ...
        expected = 10
        self.assertAlmostEqual(actual, expected, msg="Expected different value for rich percentage.")
